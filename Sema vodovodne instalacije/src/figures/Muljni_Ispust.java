...
public final class Muljni_Ispust extends Figure {
	private Point p1, p2, p3, p4, p5, p6, p7, p8, p9;
	private Point cp1;
	
	public Muljni_Ispust() {
		super();
	}
	
	public Muljni_Ispust(float x, float y, float width, float height) {
		super(x, y, width, height);
		
		double height_23 = 2 * height / 3;
		...
		this.p6 = new Point(x, y + height_23);
		this.p7 = new Point(x + width, y + height_23);
		this.p8 = new Point(x + width_2, y + height_23);
	...
	public boolean draw(Graphics g) {
		...
		Line2D bottomLeft = new Line2D.Double(this.p9.getPoint2D_D(), this.p6.getPoint2D_D());
		Line2D bottomRight = new Line2D.Double(this.p9.getPoint2D_D(), this.p7.getPoint2D_D());
		Line2D horizontal = new Line2D.Double(this.p6.getPoint2D_D(), this.p7.getPoint2D_D());
		Line2D vertical = new Line2D.Double(this.p8.getPoint2D_D(), this.p5.getPoint2D_D());
