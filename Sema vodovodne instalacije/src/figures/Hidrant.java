...
public final class Hidrant extends Figure {
	...
	public Hidrant(float x, float y, float width, float height) {
		...
		this.p6 = new Point(x + width_2, y + height_2);
		this.p7 = new Point(x + width_2, y + height);
		this.p8 = new Point(x, y + height_2 / 2);
		this.p9 = new Point(x + width, y + height_2 / 2);
	...
	public boolean draw(Graphics g) {
		...
		Line2D line = new Line2D.Double(this.p6.getPoint2D_D(), this.p7.getPoint2D_D());
		
		Arc2D leftPartCircle = DrawHelper.makeArc(this.p5, this.p8, this.p6);
		Arc2D rightPartCircle = DrawHelper.makeArc(this.p6, this.p9, this.p5);
		
		
		graphics.draw(line);
		graphics.fill(leftPartCircle);
