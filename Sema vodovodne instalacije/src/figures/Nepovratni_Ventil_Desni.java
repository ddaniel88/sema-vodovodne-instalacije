...
public final class Nepovratni_Ventil_Desni extends Figure {
	private Point p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12;
	private Point cp1, cp2;
	
	public Nepovratni_Ventil_Desni() {
		super();
	}
	
	public Nepovratni_Ventil_Desni(float x, float y, float width, float height) {
