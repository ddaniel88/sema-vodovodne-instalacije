...
public final class Vazdusni_Ventil extends Figure {
	private Point p1, p2, p3, p4, p5, p6, p7, p8, p9;
	private Point cp1;
	
	public Vazdusni_Ventil() {
		super();
	}
	
	public Vazdusni_Ventil(float x, float y, float width, float height) {
		...
		this.p6 = new Point(x, y + height_3);
		this.p7 = new Point(x + width, y + height_3);
		this.p8 = new Point(x + width_2, y + height_3);
		this.p9 = new Point(x + width_2, y + height);
		
		this.cp1 = new Point(x + width_2, y + height + 10);
	}
	...
	public boolean draw(Graphics g) {
		...
		Line2D topLeft = new Line2D.Double(this.p5.getPoint2D_D(), this.p6.getPoint2D_D());
		Line2D topRight = new Line2D.Double(this.p5.getPoint2D_D(), this.p7.getPoint2D_D());
		Line2D horizontal = new Line2D.Double(this.p6.getPoint2D_D(), this.p7.getPoint2D_D());
		Line2D vertical = new Line2D.Double(this.p8.getPoint2D_D(), this.p9.getPoint2D_D());
