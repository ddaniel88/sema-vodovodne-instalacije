...
public final class Ffr_Rp extends Figure {
	...
	public Ffr_Rp(float x, float y, float width, float height) {
		...
		this.p5 = new Point(x,y + height/6);
		this.p6 = new Point(x, y + height*5/6);
		this.p7 = new Point(x+width, y + height/2);
		this.p8= new Point(x+width, y + height/6);
		this.p9 = new Point(x+width, y + height*5/6);
...
//	}
	...
	public boolean draw(Graphics g) {
		...
		Line2D.Float l2 = new Line2D.Float(p5.getX(),p5.getY(),p7.getX(),p7.getY());
		Line2D.Float l3 = new Line2D.Float(p6.getX(),p6.getY(),p7.getX(),p7.getY());
		Line2D.Float l4 = new Line2D.Float(p8.getX(),p8.getY(),p9.getX(),p9.getY());
