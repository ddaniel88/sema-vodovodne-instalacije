...
public final class U extends Figure {
	...
	public U(float x, float y, float width, float height) {
		...
		this.p5 = new Point(x + height/2,y + height/2);
		this.p6 = new Point(x + width - height/2, y + height/2);
		this.p7 = new Point(x + height/2,y + height/2 - height/8);
		this.p8 = new Point(x + width - height/2, y + height/2 - height/8);
...
//	}
	...
	public boolean draw(Graphics g) {
		...
		Arc2D arc1 = DrawHelper.makeArc(p1, p5, p4);
		Line2D.Float l1 = new Line2D.Float(p7.getX(),p7.getY(),p8.getX(),p8.getY());
		Line2D.Float l2 = new Line2D.Float(p9.getX(),p9.getY(),p10.getX(),p10.getY());
		Line2D.Float l3 = new Line2D.Float(p5.getX(),p5.getY(),p6.getX(),p6.getY());
		Arc2D arc2 = DrawHelper.makeArc(p2, p6, p3);
